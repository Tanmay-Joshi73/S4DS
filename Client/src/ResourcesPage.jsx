      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <section className="mb-20">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { icon: <Github className="w-6 h-6" />, name: "GitHub Repos", desc: "Essential AI/ML repositories" },
              { icon: <Youtube className="w-6 h-6" />, name: "Video Tutorials", desc: "Step-by-step guides" },
              { icon: <FileText className="w-6 h-6" />, name: "Documentation", desc: "Detailed references" },
              { icon: <Download className="w-6 h-6" />, name: "Downloads", desc: "Useful tools & datasets" }
            ].map((tool, index) => (
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[1, 2, 3, 4].map((item) => (
              <div key={item} className="bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden">
                <div className="p-6">
                  <div className="flex items-center mb-4">
                    <span className="bg-emerald-100 text-emerald-800 text-xs font-medium px-2.5 py-0.5 rounded">New</span>
                    <span className="ml-2 text-gray-500 text-sm">Added today</span>
                  </div>
                  <h3 className="text-xl font-semibold mb-2">Introduction to Neural Networks</h3>
                  <p className="text-gray-600 mb-4">Comprehensive guide to understanding neural networks from the ground up.</p>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-500">By AI & DS Club</span>
